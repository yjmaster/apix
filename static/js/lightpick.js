...
(function (root, factory) {
    ...
    var document = window.document,
        ...
        //     // return new Date(1970, 0, day).toLocaleString(opts.lang, { weekday: 'short' })
        //     moment.locale("ko");
        //     var dt = moment(new Date(1970, 0, day), "YYYY-MM-DD HH:mm:ss");
        ...
        renderCalendar = function(el, opts) {
            ...
            for (var i = 0; i < opts.numberOfMonths; i++) {
                ...
                // }
                html += '<div title="일요일" style="color: red;">일</div>';
                html += '<div title="월요일">월</div>';
                html += '<div title="화요일">화</div>';
                html += '<div title="수요일">수</div>';
                html += '<div title="목요일">목</div>';
                html += '<div title="금요일">금</div>';
                html += '<div title="토요일">토</div>';
                html += '</div>';

                html += '<div class="days">';6
